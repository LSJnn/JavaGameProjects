...
public class StoryInstance extends AppCompatActivity {
...
*/
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sf.getPreferenences(StoryInstance.this);
                sf.setInt(StoryInstance.this,"page",n);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
             ...
             //storyIntent.putExtra("STORY_BACK",n);//현재 페이지
